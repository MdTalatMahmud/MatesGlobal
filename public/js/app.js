 ...
 */
// require('./bootstrap'); // inside file
__webpack_require__(/*! ./lib/jquery.mousewheel */ "./resources/js/lib/jquery.mousewheel.js"); // import 'owl.carousel';
...
var app = new vue__WEBPACK_IMPORTED_MODULE_2__.default({
  ...
  methods: {
    onSubmit: function onSubmit() {
      ...
      this.isLoading = true;
      this.form.post('/feedback').then(function (response) {
